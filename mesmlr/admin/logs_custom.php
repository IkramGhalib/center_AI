    ...
    <section class="content">
      ...
      <div class="box box-primary">
            ...
            <form role="form" action="" method="post">
              <div class="row">
                <div class="form-group col-md-3" style="margin-left: 10px">
                  <label for="exampleInputEmail1">Log Type</label>
                  <select type="text" class="form-control" id="type" name="type" required="required">
                  	<option id = "---">---Select Device---</option>
                  	<option value="raw_transfocure_log">Transformer Logs</option>
                  	<option value="raw_db_log">Distribution Box Logs</option>
                  	<option value="raw_user_current_log">User Logs</option>
                  </select>
                </div>
                <div class="form-group col-md-3" style="margin-left: 10px">
                  <label for="exampleInputEmail1">Device ID</label>
                  <input type="text" class="form-control" id="transformerid" name="transformerid" placeholder="Enter Transformer ID" required="required">
                </div>
          ...
          if(isset($_POST['sub'])){
            ...
            $query = "SELECT * FROM $type WHERE moduleid = '$trid' AND server_date_time BETWEEN '$from' AND '$to'";
            //echo $query;
