        ...
        <div class="container">
              ...
              <form class="form-horizontal" method="post">
                  <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Street Light ID</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" list="pumps" name="pumpid" placeholder="Enter Street Light ID" >
                      <datalist id="pumps">
                        <?php
