              ...
              <?php
                ...
                if(sizeof($values) > 0)
                {
                  for ($i=0; $i < $count ; $i++) {
                        ...
                        echo "  <a href='change_pump_status.php?pumpid=".$values[$i][0]."&status=Off'><button class='btn btn-success fa fa-edit'> ON</button>
                       s</a>"; 
                                                                           
                          }
                          else{
                            echo "<a href='change_pump_status.php?pumpid=".$values[$i][0]."&status=On'><button class='btn btn-danger fa fa-edit'> OFF</button>
                          </a>";
                          }
