...
foreach($result as $row)
{
       ...
       $maxCurrent = $current[$lastIndex]['a']+ $current[$lastIndex]['b']+ $current[$lastIndex]['c'];
...
//       $avgVoltage =  ($voltage[$lastIndex]['a'] + $voltage[$lastIndex]['b'] + $voltage[$lastIndex]['c'])/3;
    ...
    <?php if ($type == 1) {
      ...
      <div >
        ...
        <div class="col-lg-5" style=" margin: 10px;">
          <iframe src="cn_kwh_graph_daily.php?id=<?php echo $id; ?>" width="650" height="500" frameborder="0"></iframe>                                      
        </div>

        <div class="col-lg-5" style=" margin: 10px;">
          <iframe src="cn_kwh_graph_monthly.php?id=<?php echo $id; ?>" width="650" height="500" frameborder="0"></iframe>                                      
        </div>

        <div class="col-lg-5" style=" margin: 10px;">
          <iframe src="cn_kwh_graph_yearly.php?id=<?php echo $id; ?>" width="650" height="500" frameborder="0"></iframe>                                      
        </div>
      ...
      <div class="col-lg-5" style=" margin: 10px;">
        ...
        <div class="col-lg-5" style=" margin: 10px;">
          <iframe src="cn_kwh_graph_monthly.php?id=<?php echo $id; ?>" width="640" height="500" frameborder="0"></iframe>                                      
        </div>
