...
<?php
    ...
    $q = "select * from outfeeder where fdid ='$id'";
   //echo $q;
...
<?php
   ...
   // include_once("DBConnection.php");
    ...
    date_default_timezone_set("Asia/Karachi");
         ...
         $q=  "UPDATE outfeeder SET `name`='$tname', `description`='$description', `longitude`='$longitude', `latitude`='$latitude', kva_capacity='$capacity', mfactorvoltage = '$mfactorvoltage', mfactorcurrent = '$mfactorcurrent' where fdid='$id'";
      ...
      //  echo $q;
                    ...
                    {
                        echo "<script> alert('There was an error :".str_replace("'", "\'", $q)."'); </script>";
                    }
