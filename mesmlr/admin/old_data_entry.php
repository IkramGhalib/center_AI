...
<head>
  ...
  <?php $pageName = "PESCO Old Data Entry"?>
      ...
      <div class="box box-primary">
            ...
            <form role="form" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label >Website Peak</label>
                  <input type="text" class="form-control" name="wpeak" id="wpeak" placeholder="Webiste Peak Units">
                </div>

                <div class="form-group">
                  <label >Webiste Off Peak</label>
                  <input type="text" class="form-control" name="woffpeak" id="woffpeak" placeholder="Website Off Peak Units">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="datetime-local" class="form-control" name="time" id="time" placeholder="PESCO Off Peak Units">
                </div>
...
<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $peak = $_POST['wpeak'];
    $offpeak = $_POST['woffpeak'];
    $datetime = $_POST['time'];

    $query2 = "insert into pesco_unit_comparison (trid, our_peak_unit, our_offpeak_unit, pesco_peak_unit, pesco_offpeak_unit,datetime) values('$trid','$peak','$offpeak','$pesco_peak','$pesco_offpeak', '$datetime')";
    ...
    echo "<script > window.open('old_data_entry.php','_self'); </script>";
