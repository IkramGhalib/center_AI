...
//echo $q;
 ...
 $resultFeeder = $conn -> query($q) or die("Query error");
    ...
    {  //kvar data
       ...
       if ($id == 'I1F1') {
          $v1 = round(($row['val1']*2.2)/2.7,2);
          $v2 = round(($row['val2']*2.2)/2.7,2);
          $v3 = round(($row['val3']*2.2)/2.7,2);
        }else{
          $v1 = $row['val1'];
          $v2 = $row['val2'];
          $v3 = $row['val3'];
        }
        $kvar1 = round($row['cval1']*$v1/1000* sin(acos($row['pf1'])),2);
        $kvar2 = round($row['cval2']*$v2/1000* sin(acos($row['pf2'])),2);
        $kvar3 = round($row['cval3']*$v3/1000* sin(acos($row['pf3'])),2);
    ...
    { // kva data
      ...
      if ($id == 'I1F1') {
        ...
        $kva1 = round($row['cval1']*$v1/1000,2);
        $kva2 = round($row['cval2']*$v2/1000,2);
        $kva3 = round($row['cval3']*$v3/1000,2);
        $graphName = "KVA Graph";
