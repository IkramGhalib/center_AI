...
if (!empty($_GET))
{
        ...
        if ($api_flg=='apiucv20' )
            {
                                $strlabels= "moduleid,packet_date_time,v_red,v_blue,v_yellow,i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,i17,i18,i19,i20,i21,i22,i23,i24,i25,i26,i27,i28,i29,i30,i31,i32,pf1,pf2,pf3,pf4,pf5,pf6,pf7,pf8,pf9,pf10,pf11,pf12,pf13,pf$
...
echo $sql;
            ...
            {
                                $strLabels="moduleid,packet_date_time,v_red,v_blue,v_yellow,i1_red,i1_blue,i1_yellow,pf1_red,pf1_blue,pf1_yellow,i2_red,i2_blue,i2_yellow,pf2_red,pf2_blue,pf2_yellow,i3_red,i3_blue,i3_yellow,pf3_red,pf3_blue,pf3_yellow,i4_red,i4_blue,i4_y$
                                $strData="'".$moduleid."','".$_GET['packet_date_time']."',".$_GET['voltage'].",".$_GET['c_line1'].",".$_GET['c_line2'].",".$_GET['c_line3'].",".$_GET['c_line4'].",".$_GET['pf_line1'].",".$_GET['pf_line2'].",".$_GET['pf_line3'].",".$_GET['$
