...
$q = "select peak, offpeak, (peak+offpeak) as kwh, month(datetime) as datetime from tr_kwh_logs where trid = '$id' and datetime in (select max(datetime) from tr_kwh_logs where trid ='$id' group by month(datetime))";
