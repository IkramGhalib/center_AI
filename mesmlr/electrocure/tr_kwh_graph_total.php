...
foreach($result as $row)
{
        ...
        $kvar1 = round($row['our_peak_unit']+$row['our_offpeak_unit'],2);
        $kvar2 = round($row['pesco_peak_unit']+$row['pesco_offpeak_unit'],2);
        //$kvar3 = round($row['cval3']*$row['val3']/1000 * sin(acos($row['pf3'])),2);
        $graphName = "CISNR-PESCO Total Unit Comparison";
