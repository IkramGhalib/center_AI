...
$q = "select month(datetime) as datetime, peak, offpeak from cust_kwh_logs where cid = '$id' and datetime in (select max(datetime) from cust_kwh_logs where cid ='$id' group by month(datetime))";
