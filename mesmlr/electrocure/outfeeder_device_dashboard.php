    ...
    $feeder = $_GET['id'];
       ...
       // echo $q;
        ...
        $kvar = array();
           ...
           array_push($voltage ,array('y' => $row['datetime'],'a'  => $row['v1']*0.1732, 'b' =>$row['v2']*0.1732, 'c' => $row['v3']*0.1732));
           ...
           $kva3 = round($row['B1L'] * $row['v2']*0.1732 ,2);
       ...
       $totalcurrent = $current[0]['a']+ $current[0]['b']+ $current[0]['c'];
