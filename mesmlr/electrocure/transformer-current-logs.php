 ...
 <table width="100%" border="0"></table>
    <div  id="overflow" style="overflow-x:auto;">
        ...
        <tbody bgcolor="#FFFFFF">
          ...
          $result = $conn -> query($query) or die("Query error");
                      ...
                      if($filter == '0G0')
                  {
                      ...
                      $kva1 = round($v1*$row['B1U']/1000,2);
                      $kva2 = round($v2*$row['B1M']/1000,2);
                      $kva3 = round($v3*$row['B1L']/1000,2);
          ?>
        ...
        <tr>
          ...
          <td><?php echo round($v1,2);  ?></td>
          <td><?php echo round($v2,2);  ?></td>
          <td><?php echo round($v3,2);  ?></td>
