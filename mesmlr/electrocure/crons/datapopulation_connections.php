...
//					$frommonth = 0;
            ...
            else
            {
                if($ispeak == 1)
                {
                    ...
                    $offpeak = $arrayData[$db_index][1];
                    $arrayData[$db_index][2] = $peak;
                    $arrayData[$db_index][13] = ($arrayData[$db_index][13] + $rowdata['kwh'.$arrayData[$db_index][19]])/100;
                    $arrayData[$db_index][14] = ($arrayData[$db_index][14] + $rowdata['kwh'.$arrayData[$db_index][20]])/100;
                    $arrayData[$db_index][15] = ($arrayData[$db_index][15] + $rowdata['kwh'.$arrayData[$db_index][21]])/100;
                }
                else
                {
                    ...
                    $arrayData[$db_index][16] = ($arrayData[$db_index][16] + $rowdata['kwh'.$arrayData[$db_index][19]])/100;
                    $arrayData[$db_index][17] = ($arrayData[$db_index][17] + $rowdata['kwh'.$arrayData[$db_index][20]])/100;
                    $arrayData[$db_index][18] = ($arrayData[$db_index][18] + $rowdata['kwh'.$arrayData[$db_index][21]])/100;
                }
